...
const client = new Web3Storage({ token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweDM0OTZEZDQ4ODBmNkIyNDU4NThDMjc4QmNhNDU0QTNCNDYyYTI4MjciLCJpc3MiOiJ3ZWIzLXN0b3JhZ2UiLCJpYXQiOjE2NzU2NjgzMTkyOTAsIm5hbWUiOiJUaW1lIENhcHN1bGUifQ.YM0AuDhFbVjwkBMrIx6i5gbzXUsD8MiGoQAAkHM976k" });
...
function App() {
	...
	return (
		<div className="bg-black text-white">
			<div className="flex items-center justify-between flex-row px-4 py-2">
				{/* Logo */}
				<h1 className="text-2xl font-bold">FileStorage in IPFS</h1>
				<ConnectButton />
			</div>
			<div className="flex flex-col items-center justify-center min-h-screen">
				<h1 className="text-4xl font-extrabold">Upload your files</h1>
